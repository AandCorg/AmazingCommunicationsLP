...
export const products: Product[] = [
  ...
  },
  {
    ...
    flow: [
      ...
      "④ 移動フェーズ\n全3ラウンド制で、各ラウンドは手番順に1人ずつ必ず1マス移動します。移動先は上下左右と斜めを含む8方向から選び、他プレイヤーのコマがあるマスには入れません。",
      "⑤ 解決フェーズ\n止まったマスを公開し、得点チップなら即得点、両面後ろ向き人形カードと空白マスは何も起こりません。正面人形カードをめくるとそのターンの得点を得られず、現在の得点をすべて失います。",
      "⑥ 終了条件\n全3ラウンド終了時、またはいずれかのプレイヤーが正面人形カードを2枚めくって脱落した時点でゲーム終了です。もっとも得点が高いプレイヤーが勝利します。",
    ],
    description: [
